...
namespace Pancake.Notification
{
    ...
    public class NotificationConsole : MonoBehaviour
    {
        ...
        private IEnumerator ShowDeliveryNotificationCoroutine(IGameNotification deliveredNotification) { yield return _waitForEndOfFrame; }

        private IEnumerator UpdatePendingNotificationsNextFrame() { yield return _waitForEndOfFrame; }
    }
}
#endif